...
extension UpdateRepository {
    ...
    struct Entry: Decodable {
        ...
        var version: Version {
            VersionParser.parse(combinedVersionNumber: rawVersion)
        }
...
private extension KeyedDecodingContainer {
    ...
    func decodeVariable<T>(_: T.Type, forKey key: KeyedDecodingContainer<K>.Key) throws -> [T] where T: Decodable {
        var value: [T] = []
        do {
