...
final class AppEnvironment: ObservableObject {
	...
	#if DEBUG
	/// An offline, deterministic app state for hands-on UI acceptance testing.
	/// It never starts discovery, repository refreshes, or update checks.
...
enum LocalUATFixture {
	/// Use stable system bundles rather than invented missing paths so hands-on
	/// UAT exercises the production icon-loading and row-layout path.
	static let apps: [App] = [
