//
//  ReleaseNotesTextViewController.swift
//  Latest
//
...
private let ReleaseNotesTextParagraphCellIdentifier = NSUserInterfaceItemIdentifier(rawValue: "ReleaseNotesTextParagraphCellIdentifier")
...
class ReleaseNotesTextViewController: NSViewController {
    ...
    private func format(_ attributedString: NSAttributedString) -> NSAttributedString {
        ...
        attributedString.enumerateAttribute(NSAttributedString.Key.font, in: textRange, options: .reverse) { fontObject, range, _ in
...
extension ReleaseNotesTextViewController: ReleaseNotesContentProtocol {
    ...
    static var StoryboardIdentifier: String {
        "ReleaseNotesTextViewControllerIdentifier"
    }
}
