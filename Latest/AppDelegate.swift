...
class AppDelegate: NSObject, NSApplicationDelegate {
  ...
  private func appMenuItem() -> NSMenuItem {
    ...
    menu.addItem(
      menuItem(
        title: String(
          format: NSLocalizedString("About %@", comment: "About application menu item title"),
          appName),
    ...
    menu.addItem(
      menuItem(
        title: NSLocalizedString(
          "Check for Updates…", comment: "Sparkle application update menu item title"),
    ...
    let servicesItem = NSMenuItem(
      title: NSLocalizedString("Services", comment: "Services menu title"), action: nil,
      keyEquivalent: "")
    ...
    menu.addItem(
      menuItem(
        title: String(
          format: NSLocalizedString("Hide %@", comment: "Hide application menu item title"), appName
        ),
    ...
    menu.addItem(
      menuItem(
        title: String(
          format: NSLocalizedString("Quit %@", comment: "Quit application menu item title"), appName
        ),
  ...
  private func fileMenuItem() -> NSMenuItem {
    ...
    menu.addItem(
      menuItem(
        title: NSLocalizedString(
          "Show in Finder", comment: "Show selected app in Finder menu item title"),
    ...
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Close", comment: "Close menu item title"),
        action: #selector(NSWindow.performClose(_:)), keyEquivalent: "w"))
    return parentMenuItem(
      title: NSLocalizedString("File", comment: "File menu title"), submenu: menu)
  }
  ...
  private func editMenuItem() -> NSMenuItem {
    ...
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Undo", comment: "Undo menu item title"),
        action: Selector(("undo:")), keyEquivalent: "z"))
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Redo", comment: "Redo menu item title"),
        action: Selector(("redo:")), keyEquivalent: "Z"))
    menu.addItem(.separator())
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Cut", comment: "Cut menu item title"),
        action: #selector(NSText.cut(_:)), keyEquivalent: "x"))
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Copy", comment: "Copy menu item title"),
        action: #selector(NSText.copy(_:)), keyEquivalent: "c"))
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Paste", comment: "Paste menu item title"),
        action: #selector(NSText.paste(_:)), keyEquivalent: "v"))
    menu.addItem(
      menuItem(
        title: NSLocalizedString(
          "Paste and Match Style", comment: "Paste and match style menu item title"),
        action: #selector(NSTextView.pasteAsPlainText(_:)), keyEquivalent: "V"))
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Delete", comment: "Delete menu item title"),
        action: #selector(NSText.delete(_:))))
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Select All", comment: "Select all menu item title"),
        action: #selector(NSText.selectAll(_:)), keyEquivalent: "a"))
    menu.addItem(.separator())
    menu.addItem(findMenuItem())
    return parentMenuItem(
      title: NSLocalizedString("Edit", comment: "Edit menu title"), submenu: menu)
  }
  ...
  private func findMenuItem() -> NSMenuItem {
    ...
    menu.addItem(
      menuItem(
        title: NSLocalizedString(
          "Use Selection for Find", comment: "Use selection for find menu item title"),
        action: #selector(MainWindowController.performFindPanelAction(_:)),
        keyEquivalent: "e"
      ))
    return parentMenuItem(
      title: NSLocalizedString("Find", comment: "Find menu title"), submenu: menu)
  }

  private func viewMenuItem() -> NSMenuItem {
    let menu = NSMenu(title: NSLocalizedString("View", comment: "View menu title"))
    let sortItem = parentMenuItem(
      title: NSLocalizedString("Sort By", comment: "Sort by menu title"),
      submenu: NSMenu(title: NSLocalizedString("Sort By", comment: "Sort by menu title")))
    ...
    menu.addItem(
      menuItem(
        title: NSLocalizedString(
          "Show Installed Apps", comment: "Show installed apps menu item title"),
    ...
    menu.addItem(
      menuItem(
        title: NSLocalizedString(
          "Check for Updates…", comment: "Check app update availability menu item title"),
    ...
    return parentMenuItem(
      title: NSLocalizedString("View", comment: "View menu title"), submenu: menu)
  }
  ...
  private func windowMenuItem() -> NSMenuItem {
    ...
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Minimize", comment: "Minimize menu item title"),
        action: #selector(NSWindow.performMiniaturize(_:)), keyEquivalent: "m"))
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Zoom", comment: "Zoom menu item title"),
        action: #selector(NSWindow.performZoom(_:))))
    menu.addItem(.separator())
    menu.addItem(
      menuItem(
        title: NSLocalizedString(
          "Bring All to Front", comment: "Bring all to front menu item title"),
        action: #selector(NSApplication.arrangeInFront(_:)), target: NSApp))
    NSApp.windowsMenu = menu
    return parentMenuItem(
      title: NSLocalizedString("Window", comment: "Window menu title"), submenu: menu)
  }
  ...
  private func helpMenuItem() -> NSMenuItem {
    ...
    menu.addItem(
      menuItem(
        title: NSLocalizedString("Latest Help", comment: "Latest help menu item title"),
    ...
    NSApp.helpMenu = menu
    return parentMenuItem(
      title: NSLocalizedString("Help", comment: "Help menu title"), submenu: menu)
  }
