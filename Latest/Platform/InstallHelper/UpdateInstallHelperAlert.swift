...
enum UpdateInstallHelperAlert {
  ...
  static func present(with error: InstallHelperError, fallbackURL: URL) {
    ...
    alert.messageText = NSLocalizedString(
      "UpdateInstallHelperAlert.Title",
    ...
    case .installHelperNotRegistered:
      primaryTitle = NSLocalizedString(
    ...
    case .installHelperRequiresApproval:
      primaryTitle = NSLocalizedString(
        "UpdateInstallHelperAlert.Primary.OpenSettings",
    ...
    alert.addButton(
      withTitle: NSLocalizedString(
        "UpdateInstallHelperAlert.Secondary.AppStore",
        comment: "Button to update the app in the App Store"))
    alert.addButton(
      withTitle: NSLocalizedString(
        "UpdateInstallHelperAlert.Cancel",
